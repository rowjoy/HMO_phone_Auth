...
class Plasamacard extends StatefulWidget {
  final String name;
  ...
  @override
  _PlasamacardState createState() => _PlasamacardState();
}

class _PlasamacardState extends State<Plasamacard> {
  @override
