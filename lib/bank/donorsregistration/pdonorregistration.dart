...
class PlasamadonorRegistration extends StatefulWidget {
  const PlasamadonorRegistration({Key? key}) : super(key: key);

  @override
  _BloodRegistrationState createState() => _BloodRegistrationState();
}

class _BloodRegistrationState extends State<PlasamadonorRegistration> {
  @override
