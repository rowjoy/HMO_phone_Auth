...
class _BloodgroupState extends State<SelectBloodGroup> {
  var bloodgroupitem = 0;
  List selectBloodbankgroup = [
    "A+",
    "O+",
    "B+",
    "AB+",
          ...
          Container(
            ...
            child: Padding(
              ...
              child: DropdownButton(
                ...
                items: [
                  for (int i = 0; i < selectBloodbankgroup.length; i++)
                    DropdownMenuItem(
                      value: i,
                      child: Text(selectBloodbankgroup[i]),
                    ),
                ],
                onChanged: (int? value) {
                  setState(() {
